      ...
      @if (portfolio()) {
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-2xl font-bold text-green-600">{{ getTotalWeight() }}%</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <tbody class="bg-white divide-y divide-slate-200">
                    @for (stock of portfolio()!.stocks; track stock.id) {
                      <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                          <span class="text-sm text-slate-900">{{ stock.weight }}%</span>
                        </td>
        ...
        <div class="min-h-screen flex items-center justify-center">
          <div class="text-center">
            ...
            <button (click)="goBack()" class="text-blue-600 hover:text-blue-800">← Back to Portfolios</button>
          </div>
        </div>
      }
    </div>
