          ...
          @if (portfolioService.portfolios().length > 0) {
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              @for (
                ...
                <div
                  class="bg-white rounded-xl shadow-lg border border-slate-200 p-6 hover:shadow-xl transition-shadow cursor-pointer"
...
export class PortfolioListComponent implements OnInit {
  ...
  createPortfolio(): void {
    ...
    this.notificationService.info(
      "Coming Soon",
      "Portfolio creation functionality will be available soon",
    );
  }
