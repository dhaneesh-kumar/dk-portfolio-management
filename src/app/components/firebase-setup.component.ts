  ...
  template: `
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
      <div class="flex items-start">
        ...
        <div class="flex-1">
          <h3 class="text-blue-800 font-semibold mb-2">Firebase Setup Required</h3>
          <p class="text-blue-700 text-sm mb-4">
            To enable data persistence, please configure Firebase Firestore. Currently running with sample data.
          </p>
          
          <details class="text-sm">
            <summary class="text-blue-800 font-medium cursor-pointer hover:text-blue-900">
              📋 Setup Instructions
            </summary>
            <div class="mt-3 pl-4 border-l-2 border-blue-200">
              <ol class="list-decimal list-inside space-y-2 text-blue-700">
                ...
                <li>Update <code class="bg-blue-100 px-1 rounded">src/app/config/firebase.config.ts</code> with your Firebase config</li>
                <li>Set up Firestore security rules (start with test mode for development)</li>
              </ol>
  ...
  appId: "your-app-id"
              ...
              <div class="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p class="text-sm text-yellow-800">
                  <strong>🔒 Security Note:</strong> For production, configure proper Firestore security rules and use environment variables for sensitive configuration.
                </p>
              </div>
            </div>
          </details>
