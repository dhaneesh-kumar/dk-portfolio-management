    ...
    >
      <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-8">
        ...
        <div class="mt-8 text-center">
          ...
          <div
            class="flex items-center justify-center mt-4 space-x-4 text-xs text-gray-500"
          >
            <span>���� Secure</span>
            <span>🚀 Fast</span>
            <span>🌐 Global</span>
        ...
        <div class="mt-8 p-4 bg-blue-50 rounded-lg">
          <h3 class="font-semibold text-blue-900 text-sm mb-2">Features</h3>
          <ul class="text-blue-800 text-sm space-y-1">
            <li>📊 Create and manage multiple portfolios</li>
            <li>🤝 Share portfolios with team members</li>
            <li>📝 Add personal notes and analysis</li>
            <li>📈 Track performance and rebalance</li>
