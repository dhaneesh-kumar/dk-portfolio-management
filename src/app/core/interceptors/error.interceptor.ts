...
export class ErrorInterceptor implements HttpInterceptor {
  ...
  private handleError(error: HttpErrorResponse): void {
    ...
    switch (error.status) {
      ...
      case 409:
        errorTitle = 'Conflict';
        errorMessage = error.error?.message || 'A conflict occurred while processing your request.';
        break;
      case 422:
      ...
      case 503:
        ...
        break;
      default:
        errorMessage = error.error?.message || `An error occurred (Status: ${error.status})`;
    }
