            ...
            <form (ngSubmit)="sharePortfolio()" #shareForm="ngForm">
              ...
              <div class="mb-6">
                ...
                <textarea
                  ...
                  rows="3"
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Hey! I'd like to share my portfolio with you for feedback..."
                ></textarea>
              </div>
                ...
                <div class="space-y-3">
                  <label class="flex items-center">
                    ...
                    <span class="ml-3 text-sm text-gray-700">
                      <strong>Can Comment</strong> - Add suggestions and
                      feedback
                    </span>
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-3 text-sm text-gray-700">
                      <strong>Can Edit Portfolio</strong> - Modify portfolio
                      details
                    </span>
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-3 text-sm text-gray-700">
                      <strong>Can Edit Stocks</strong> - Add/remove stocks from
                      portfolio
                    </span>
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-3 text-sm text-gray-700">
                      <strong>Can Edit Weights</strong> - Modify stock
                      allocation weights
                    </span>
                  </label>
                  ...
                  <label class="flex items-center">
                    ...
                    />
                    <span class="ml-3 text-sm text-gray-700">
                      <strong>Can Add Notes</strong> - Add personal notes to
                      stocks
                    </span>
                  </label>
                </div>
...
export class SharePortfolioComponent {
  ...
  async loadExistingShares() {
    ...
    try {
      const shares = await this.portfolioService.getPortfolioShares(
        this.portfolioId,
      );
